...
export default function OdemePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.push('/misafir/rezervasyon-basarili');
  };
      ...
      <div className="w-[260px] bg-[#163a22] flex flex-col text-white z-20">
        <div className="pt-8">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link href="/misafir/konaklama" className="flex items-center gap-3 py-3.5 px-5 bg-[#21472e] text-white border-l-4 border-[#8fbc9f] text-[0.95rem] transition-all duration-200">
          ...
          <div className="bg-white w-full max-w-[900px] rounded-xl p-8 md:px-10 shadow-[0_8px_24px_rgba(0,0,0,0.04)] relative z-10">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between items-center relative">
                <Link href="/misafir/on-izleme" className="bg-white border border-[#ccc] text-[#555] py-2.5 px-6 rounded-md text-[0.9rem] font-medium inline-flex items-center gap-2 transition-colors hover:bg-[#f0f0f0]">
                  ← Geri
                </Link>

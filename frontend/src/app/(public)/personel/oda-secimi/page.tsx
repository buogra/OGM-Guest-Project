...
export default function OdaSecimiPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push('/personel/on-izleme');
  };
          ...
          <div className="bg-white w-full max-w-[900px] rounded-xl p-8 md:px-10 shadow-[0_8px_24px_rgba(0,0,0,0.04)] relative z-10">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between items-center relative">
                <Link href="/personel/konaklama" className="bg-white border border-[#ccc] text-[#555] py-2.5 px-6 rounded-md text-[0.9rem] font-medium inline-flex items-center gap-2 transition-colors hover:bg-[#f0f0f0]">
                  ← Geri
                </Link>

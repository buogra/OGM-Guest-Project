      ...
      <div className="w-[260px] bg-[#163a22] flex flex-col text-white z-20">
        <div className="pt-8">
          ...
          <div className="flex flex-col gap-1">
            <Link href="/personel/dashboard" className="flex items-center gap-3 py-3.5 px-5 text-[#a8c1b1] hover:text-white hover:bg-white/5 text-[0.95rem] transition-all duration-200">
            ...
            <Link href="/personel/rezervasyonlarim" className="flex items-center gap-3 py-3.5 px-5 bg-[#21472e] text-white border-l-4 border-[#8fbc9f] text-[0.95rem] transition-all duration-200">
        ...
        <div className="flex-1 p-10 flex justify-center items-start gap-8 overflow-y-auto">
          ...
          <div className="bg-white rounded-xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.04)] text-center w-full max-w-[550px]">
            ...
            <div className="flex gap-4">
              <Link href="/personel/rezervasyonlarim" className="flex-1 bg-[#1c4227] text-white text-center py-4 rounded-lg font-semibold text-[1rem] transition-colors hover:bg-[#122a1a]">
                Rezervasyonlarıma Git
              </Link>
              <Link href="/personel/dashboard" className="flex-1 bg-white text-[#333] border border-[#ddd] text-center py-4 rounded-lg font-semibold text-[1rem] transition-colors hover:bg-[#f0f0f0]">
                Ana Sayfaya Dön
              </Link>
            </div>
          </div>

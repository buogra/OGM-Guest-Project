...
export default function DashboardPage() {
  ...
  const aktifKullanici = kullanici?.adSoyad ?? "Personel";
  const rezSayisi = 0;
      ...
      <div className="w-[260px] bg-[#163a22] flex flex-col text-white z-20">
        <div className="pt-8">
          ...
          <div className="flex flex-col gap-1">
            <Link href="/personel/dashboard" className="flex items-center gap-3 py-3.5 px-5 bg-[#21472e] text-white border-l-4 border-[#8fbc9f] text-[0.95rem] transition-all duration-200">
              <svg viewBox="0 0 24 24" className="w-[18px] h-[18px] fill-current"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
              Ana Sayfa
            </Link>
            <Link href="/personel/konaklama" className="flex items-center gap-3 py-3.5 px-5 text-[#a8c1b1] hover:text-white hover:bg-white/5 text-[0.95rem] transition-all duration-200">
            ...
            <Link href="/personel/rezervasyonlarim" className="flex items-center gap-3 py-3.5 px-5 text-[#a8c1b1] hover:text-white hover:bg-white/5 text-[0.95rem] transition-all duration-200">
            ...
            <Link href="/personel/iletisim" className="flex items-center gap-3 py-3.5 px-5 text-[#a8c1b1] hover:text-white hover:bg-white/5 text-[0.95rem] transition-all duration-200">
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <div className="flex-1 p-12 flex flex-col items-center relative z-10 overflow-y-auto">
          ...
          <div className="bg-white w-full max-w-[900px] p-6 px-8 rounded-lg shadow-[0_4px_10px_rgba(0,0,0,0.02)] mb-10 relative z-10">
            ...
            <p className="text-[0.9rem] text-[#555]">OGM personeli olarak rezervasyon portalına hoş geldiniz. Aşağıdan işlemlerinizi gerçekleştirebilirsiniz.</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-5 w-full max-w-[900px] justify-center relative z-10">
            ...
            <div className="bg-white w-full max-w-[400px] rounded-lg p-10 px-6 text-center shadow-[0_4px_15px_rgba(0,0,0,0.03)] border-l-[5px] border-l-[#2b5e39] border-t border-r border-b border-[#eaeaea] flex flex-col items-center transition-all duration-400 cursor-pointer hover:-translate-y-3 hover:scale-[1.02] hover:shadow-[0_20px_30px_rgba(0,0,0,0.08)] hover:border-l-[#1a4225] group">
              ...
              <Link href="/personel/konaklama" className="bg-[#3b6b4a] text-white px-7 py-2.5 rounded-md text-[0.9rem] font-medium transition-colors hover:bg-[#2b5e39]">
                Oluştur →
              </Link>
            </div>
            ...
            <div className="bg-[#fcfffd] w-full max-w-[400px] rounded-lg p-10 px-6 text-center shadow-[0_6px_20px_rgba(22,58,34,0.08)] border-2 border-[#bce3cc] border-l-[5px] border-l-[#2b5e39] flex flex-col items-center transition-all duration-400 cursor-pointer hover:-translate-y-3 hover:scale-[1.02] hover:shadow-[0_20px_35px_rgba(22,58,34,0.15)] group">
              ...
              <Link href="/personel/rezervasyonlarim" className="bg-[#3b6b4a] text-white px-7 py-2.5 rounded-md text-[0.9rem] font-medium transition-colors hover:bg-[#2b5e39]">
                Görüntüle →
              </Link>
            </div>
